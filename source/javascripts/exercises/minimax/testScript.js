...
for(var i=0;i<rows;i++){
	...
	for(var j=0;j<columns;j++){
		...
		pacmanToggle[i][j]=paper.image("/Users/abhishek/Desktop/pacman.png", 100+j*40,100+i*40,40,40).attr({stroke:"white"}).toFront();
		ghostToggle[i][j]=paper.image("/Users/abhishek/Desktop/ghost.png", 100+j*40,100+i*40,40,40).attr({stroke:"white"}).toFront();
		foodToggle[i][j]=paper.image("/Users/abhishek/Desktop/food.png", 100+j*40,100+i*40,40,40).attr({stroke:"white"}).toFront();
		...
		var Contacts = {
			...
			boardsAdd: function(entry) {
				...
				for(var i=0;i<entry.pacmanx.length;i++){
					pacmans[boardsIndex][i]=paper.image("/Users/abhishek/Desktop/pacman.png", 900+entry.pacmanx[i]*40,200+entry.pacmany[i]*40,40,40).attr({stroke:"white"}).toFront();
					pacmans[boardsIndex][i].hide();
				}
				for(var i=0;i<entry.ghostx.length;i++){
					ghosts[boardsIndex][i]=paper.image("/Users/abhishek/Desktop/ghost.png", 900+entry.ghostx[i]*40,200+entry.ghosty[i]*40,40,40).attr({stroke:"white"}).toFront();
					ghosts[boardsIndex][i].hide();
				}
				for(var i=0;i<entry.foodx.length;i++){
					foods[boardsIndex][i]=paper.image("/Users/abhishek/Desktop/food.png", 900+entry.foodx[i]*40,200+entry.foody[i]*40,40,40).attr({stroke:"white"}).toFront();

...
(function () { 
		...
		paper.image("/images/exercises/csps/basic_MinConflict/board.png", 0, 0, 364, 366);
		//define queen class
		function queen(col, drawToggle) {
				...
				this.img = null;
				if (drawToggle) { 
						this.img = paper.image("/images/exercises/csps/basic_MinConflict/queen.png", 8, 12, 80, 80).attr(this.pos); 
